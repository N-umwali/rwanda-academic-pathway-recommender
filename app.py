...
with st.sidebar:
    ...
    render_html(
        ...
        <div class="sidebar-brand">
            {brand_media}
            {brand_title}
            <div class="sidebar-subtitle">Academic pathway, program category, and bridge-course decision-support system.</div>
        </div>
        """
    )
...
<div class="top-header">
    <div class="header-left">
        ...
        <div>
            ...
            <div class="header-title">Academic Guidance Decision-Support System</div>
        </div>
    </div>
...
if selected_page == "Home":
    ...
    render_html(
        ...
        <div class="hero-card">
            <div class="hero-grid">
                <div>
                    <div class="hero-kicker">Decision-Support System • Explainable Guidance • Rwanda Context</div>
                    ...
                    <div class="hero-body">
                        A professional decision-support System that helps Rwandan learners explore suitable academic program categories,
                    ...
                    <span class="badge badge-blue">Research System</span>
    ...
    with right_col:
        ...
        quick_action("Advisor Dashboard", "Review system evaluation indicators", "open-dashboard.svg", "Advisor Dashboard")
        quick_action("How the System Works", "Read the hybrid methodology", "system-methodology.svg", "Methodology")
        quick_action("Responsible Use", "Advisory scope and limits of the system", "open-responsible-use.svg", "Responsible Use")

    st.markdown('<div class="info-box"><b>Advisory notice:</b> This portal is a decision-support system. Recommendations are for exploration and advisor discussion; final academic decisions must follow official MINEDUC, REB, RTB, and institutional admission requirements.</div>', unsafe_allow_html=True)
    ...
    st.markdown('<div class="section-card"><div class="section-title">Advisor Dashboard</div><div class="section-body">This section summarizes system evaluation indicators for advisor review and stakeholder discussion.</div></div>', unsafe_allow_html=True)
    ...
    st.markdown('<div class="info-box"><b>Advisor note:</b> This dashboard is the system for monitoring and presentation. It does not represent official national analytics.</div>', unsafe_allow_html=True)
    ...
    st.markdown('<div class="warning-box"><b>Important:</b> This is a capstone system and not an official government system.</div>', unsafe_allow_html=True)
    ...
    <div class="section-card">
        ...
        <div class="section-body">
            This system is an academic research system and decision-support tool. It supports exploration, counseling, and discussion. It should not be used as the final authority for university admission, scholarship selection, program placement, or official education policy decisions.
            <br><br>
    ...
    banner(
        ...
        "System Evaluation",
        "System Feedback",
        "This section collects feedback on usefulness, explanation clarity, and usability for system evaluation.",
    )
    ...
    if feedback_submitted:
        ...
        result_card("Feedback Submitted Successfully", "Thank you", "Your feedback has been recorded and will support system evaluation.", "green")
...
st.markdown("""
<div class="footer">
    <b>Rwanda Academic Guidance Portal — Decision-Support System</b><br>
